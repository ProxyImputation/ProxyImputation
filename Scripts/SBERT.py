...
config = pathlib.Path(__file__).parent.resolve() / "config.txt"
...
for line in c:
	line = line.rstrip('\n')
	s = line.split('=')
	if s[0] == "embeddings_path":
		embeddings = s[1]

events = embeddings + "/EmbeddingEvents.txt"
attributes = embeddings + "/EmbeddingAttributes.txt"
facts = embeddings + "/EmbeddingFacts.txt"
properties = embeddings + "/EmbeddingProperties.txt"
titles = embeddings + "/EmbeddingTitles.txt"
values = embeddings + "/EmbeddingValues.txt"


eventOutput = embeddings + "/EmbeddingScoresReduced.txt"
factOutput = embeddings + "/FactEmbeddingScoresReduced.txt"
titleOutput = embeddings + "/TitleEmbeddingScoresReduced.txt"
valueOutput = embeddings + "/ValueEmbeddingScoresReduced.txt"
vtOutput = embeddings + "/VTEmbeddingScoresReduced.txt"
