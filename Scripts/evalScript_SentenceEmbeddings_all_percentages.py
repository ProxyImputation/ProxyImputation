...
def run_experiments(file1_path, file2_path, column_name, deletion_percentage, deletion_mode, catconv=False):
    ...
    for _ in range(10):
        rmse1, mae1, rmse2, mae2 = main(file1_path, file2_path, column_name, deletion_percentage, deletion_mode, catconv)
    ...
    save_results_to_file(file1_path, rmse_results_file1, rmse_results_file2, mae_results_file1, mae_results_file2, str(deletion_percentage), str(deletion_mode))
...
def save_results_to_file(file1_path, rmse_results_file1, rmse_results_file2, mae_results_file1, mae_results_file2, percentage, deletion_mode):
    # Remove '.csv' from file1_path and append '_results.txt'
    base_name = os.path.splitext(file1_path)[0]
    results_file = f"{base_name}_se_results.txt"
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print("Usage: script.py <file1.csv> <file2.csv> <column_name>")
        sys.exit()
